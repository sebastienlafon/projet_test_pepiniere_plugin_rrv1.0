...
//    $second_month = $_POST["secondMonth"];
//
//require('../../../../wp-load.php');
//require_wp_db();
//global $wpdb;
//
//
//$resv_sql = "SELECT year, month, dates, room, pending, booking_ref  FROM " . $wpdb->prefix . "RR_resv WHERE year = $current_year AND (month = $current_month OR month = $second_month)";    
...
//
//$orders_sql = "SELECT * FROM " . $wpdb->prefix . "RR_orders WHERE year = $current_year AND (month = $current_month OR month = $second_month)";    
